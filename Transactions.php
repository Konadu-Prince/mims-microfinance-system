                ...
                ?>
                    ...
                    <tbody class="table-bordered">
                        <tr>
                            ...
                            <td colspan="">
                                <a href="updateTransaction.php?transaction_number=<?php echo $result["transaction_number"]; ?>" type="submit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
                                <a href="app/deletecustomerTransactions.php?transaction_number=<?php echo $result["transaction_number"]; ?>" type="submit" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
