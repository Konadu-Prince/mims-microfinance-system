...
WHERE loans_number = '" . $_GET['loans_number'] . "'");
    ...
    <div class="card ">
        ...
        <div class="card-body">
            <div class="card-text">
                ...
                <form action="app/updateLoanHandler.php" method="post">
                    <div class="row">
                        <?php

                        $account_number =  $row['loans_number'];
                        ?>
                        <div class="col-md-12 col-sm-6">
                            <div class="form-group">
                                <label for="transaction number">Loans number</label>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" name="UpdateLoan">Update Loan</button>
                    </div>
