...
<body>
  ...
  <body>
    ...
    <div class="topnav" id="myTopnav">
      ...
      <a href="pdfcustomer.php"><i class="fas fa-print"></i> Print all customer</a>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-4">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="number" name="customer_number" class="form-control" placeholder="Customer number" value="<?php echo $customer_number . $costant; ?>" readonly>
        ...
        <div class="col-md-12 col-sm-4">
          <div class="form-group">
            ...
            <input type="text" name="hometown" id="" class="form-control" placeholder="Hometown">
          </div>
        </div>
