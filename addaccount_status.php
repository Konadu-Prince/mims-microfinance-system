            ...
            <div class="card-text">
               <form action="app/addaccounts_statusHandler.php" method="post" autocomplete="off">
                  <div class="form-group">
                     ...
                     <input type="text" name="account_status_number" id="" class="form-control" placeholder="Account status number" aria-describedby="helpId" value=" <?php echo $account_type_number; ?>" readonly>
                  </div>
                  <div class="form-group">
                     <label for="account name">Account status name</label>
                     <input type="text" name="account_status_name" id="" class="form-control" placeholder="Account status name" aria-describedby="helpId">
                  </div>
