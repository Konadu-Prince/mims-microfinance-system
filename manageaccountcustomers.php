                ...
                ?>
                    ...
                    <tbody class="table-bordered">
                        <tr>
                            ...
                            <td colspan="">
                                <a href="updateaccount.php?account_number=<?php echo $result["account_number"]; ?>" type="submit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
                                <a href="app/deletecustomeraccount.php?account_number=<?php echo $result["account_number"]; ?>" type="submit" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                                <a href="pdf_singlecustomeraccount.php?account_number=<?php echo $result['account_number']; ?>" type="submit" class="btn btn-primary" target="_blank"><i class="fas fa-print"></i> Print</a>
                            </td>
                        </tr>
                    </tbody>
                <?php
