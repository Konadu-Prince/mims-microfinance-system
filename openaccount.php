               ...
               <div class="row">
                  ...
                  <div class="col-md-12 col-sm-6">
                     <div class="form-group">
                        ...
                        <input type="text" name="account_number" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo $account_number; ?>" readonly>
                     </div>
                  </div>
                  <div class="col-md-12 col-sm-6">
                     <div class="form-group">
                        ...
                        <select class="custom-select" name="account_type" id="">
                           ...
                           ?>
                              ...
                              <option value="<?php echo $rows['account_type_number']; ?>">
                                 <?php echo $rows['account_type_name']; ?></option>
                           <?php } ?>
                        </select>
                     </div>
                  </div>
                        ...
                        <select class="custom-select" name="account_status" id="">
                           ...
                           ?>
                              ...
                              <option value="<?php echo $rows['account_status_number']; ?>">
                                 <?php echo $rows['account_status_name']; ?></option>
                           <?php } ?>
                        </select>
                     </div>
                  </div>
