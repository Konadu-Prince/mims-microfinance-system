...
<body>
   ...
   ?>
      ...
      <div class="topnav" id="myTopnav">
         <a href="addcustomer_type.php" class="active"><i class="fas fa-user-plus"></i> Add New Susu Account</a>
         ...
         ?>
            ...
            <tbody class="table-bordered">
               <tr>
                  ...
                  <td>
                     <a href="update_customertype.php?customer_type_number=<?php echo $result["customer_type_number"]; ?>" type="submit" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
                     <a href="app/deletecustomer_type.php?customer_type_number=<?php echo $result["customer_type_number"]; ?>" type="submit" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
