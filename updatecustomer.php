...
<body>
  ...
  <body>
    <div class="alert alert-success alert-dismissible fade show " role="alert">
      ...
      <strong><?php if (isset($success_msg)) {
                echo $query['first_name'] . $success_msg;
              } ?></strong>
    </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="number" name="" class="form-control" placeholder="Customer number" value="<?php echo $query['customer_number']; ?>" readonly>
        ...
        <div class="col-md-6 col-sm-4">
          <div class="form-group">
            ...
            <input type="text" name="first_name" id="" class="form-control" placeholder="First name" value="<?php echo $query['first_name']; ?>">
          </div>
        </div>
        ...
        <div class="col-md-6 col-sm-4">
          <div class="form-group">
            ...
            <input type="text" name="middle_name" id="" class="form-control" placeholder="Middle name" value="<?php echo $query['middle_name']; ?>">
          </div>
        </div>
        ...
        <div class="col-md-6 col-sm-4">
          <div class="form-group">
            ...
            <input type="text" name="surname" id="" class="form-control" placeholder="Surname" value="<?php echo $query['surname']; ?>">
          </div>
        </div>
        ...
        <div class="col-md-12 col-sm-4">
          <div class="form-group">
            ...
            <input type="date" name="date_of_birth" id="" class="form-control" placeholder="Date of birth" value="<?php echo $query['date_of_birth']; ?>">
          </div>
        </div>
        ...
        <div class="col-md-12 col-sm-4">
          <div class="form-group">
            ...
            <input type="text" name="hometown" id="" class="form-control" placeholder="Hometown" value="<?php echo $query['hometown']; ?>">
          </div>
        </div>
        ...
        <div class="col-md-12 col-sm-4">
          <div class="form-group">
            ...
            <input type="email" name="email" id="" class="form-control" placeholder="Email" value="<?php echo $query['email']; ?>">
          </div>
        </div>
        ...
        <div class="col-md-12 col-sm-4">
          <div class="form-group">
            ...
            <input type="number" name="contact" id="" class="form-control" placeholder="Contact" value="<?php echo $query['contact']; ?>">
          </div>
        </div>
